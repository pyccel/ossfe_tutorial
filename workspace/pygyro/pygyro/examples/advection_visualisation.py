...
from pygyro.advection.advection import FluxSurfaceAdvection, VParallelAdvection, PoloidalAdvection
...
plot = SlicePlotterNd(
    grid, 0,0,False, comm, drawingRank=drawRank, drawRankInGrid=False)
